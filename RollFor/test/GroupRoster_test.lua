...
local mocking = require( "test/common/mocking" )
local mock, mock_api = mocking.mock, mocking.mock_api
local smart_table, packed_value = mocking.smart_table, mocking.packed_value

require( "RollFor/test/utils" ) -- Need to load this before modules to load lua50 stuff.
require( "src/modules" )
require( "src/Types" )

local mock_player_info = require( "test/common/mocks/PlayerInfo" ).new
