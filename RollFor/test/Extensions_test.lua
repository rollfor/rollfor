...
-- Context is now v7 (v2 added api, softres_source, softres_tap and minimap for the
...
-- v6 put the loot pipeline on phases; v7 added roll_modifier.preview), but an extension built against v1 must keep loading
